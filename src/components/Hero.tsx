...
import ReadAlongStatic from "./ReadAlongStatic";
...
export default function Hero() {
  ...
  return (
    <section
      id="about"
      className="relative min-h-full lg:min-h-screen md:pt-24 px-4 overflow-hidden"
    >
      ...
      {/* bottom left light */}
      <motion.div
        className="absolute bottom-40 right-20 w-32 h-32 bg-indigo-500 rounded-full opacity-50 blur-3xl"
        animate={{
          y: ["0%", "10%", "0%"],
          transition: {
            duration: 5,
      ...
      {/* top left light */}
      <motion.div
        className="absolute top-20 left-20 w-32 h-32 bg-indigo-500 rounded-full opacity-50 blur-3xl"
        animate={{
          y: ["0%", "10%", "0%"],
          transition: {
            duration: 5,
